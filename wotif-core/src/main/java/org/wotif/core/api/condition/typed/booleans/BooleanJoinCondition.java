...
public class BooleanJoinCondition extends AbstractJoinCondition<Boolean, BooleanCondition> implements IBooleanCondition {
    ...
    public BooleanJoinCondition(JoinEnum joinType, Boolean... terms) { super(joinType, terms); }
    ...
    @Override
    public CompletableResult isTrue() { return this.functionToApply.apply(b-> b.isTrue().value()); }

    @Override
    public CompletableResult isFalse() { return this.functionToApply.apply(b -> b.isFalse().value()); }
